...
#define SUPPORTED_LANGUAGES ":bg:bs:ca:cs:da:de:el:en-GB:en:es:eu:fi:fr:gl:he:hr:hu:id:it:ja:ko:lt:lv:mk:mn:nl:no:pl:pt-BR:pt:ro:ru:sk:sl:sr:sr-YU:sv:th:tr:uk:vi:zh-TW:zh:"
